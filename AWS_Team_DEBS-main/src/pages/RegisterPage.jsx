...
export default function RegisterPage() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            // Real Cognito: userConfirmed === false means email verification needed
            // Demo mode: no userConfirmed field → go directly to login
                ...
                {step === 'register' ? (
                    <form onSubmit={handleRegister} className="card" style={{ padding: 'var(--space-lg)' }}>
                        ...
                        <div style={{ marginBottom: 'var(--space-md)' }}>
                            ...
                            <input id="reg-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="your@email.com" autoComplete="username" required />
                        </div>
