        ...
        <div className="page-enter" style={{
            ...
            <div style={{
                ...
                <form onSubmit={handleSubmit} className="card" style={{ padding: 'var(--space-lg)' }}>
                    ...
                    <div style={{ padding: 'var(--space-sm) var(--space-md)', background: 'var(--color-jet)', color: 'var(--color-brass)', borderRadius: 'var(--radius-md)', fontSize: 'var(--font-size-caption)', marginBottom: 'var(--space-md)', textAlign: 'center' }}>
                        Demo credentials (no AWS needed): <strong>demo_user_1</strong> / <strong>password123</strong>
                    </div>
