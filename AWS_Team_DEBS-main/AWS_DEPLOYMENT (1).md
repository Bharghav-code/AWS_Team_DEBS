...
aws apigateway create-authorizer \
  ...
  --provider-arns arn:aws:cognito-idp:ap-south-1:<ACCOUNT_ID>:userpool/<USER_POOL_ID> \
...
API URL: `https://<API_ID>.execute-api.ap-south-1.amazonaws.com/v1`
...
```bash
aws s3 mb s3://virale-app --region ap-south-1
```
  ...
  --distribution-config '{
    ...
    "Origins": {
      ...
      "Items": [
        ...
        {
          "Id": "APIOrigin",
          "DomainName": "<API_ID>.execute-api.ap-south-1.amazonaws.com",
          "OriginPath": "/v1",
          "CustomOriginConfig": {
            "HTTPSPort": 443,
...
|----------|-------|---------|
| `COGNITO_USER_POOL_ID` | `ap-south-1_XXXXXXX` | virale-auth |
...
# 2. Test API Health
curl https://<API_ID>.execute-api.ap-south-1.amazonaws.com/v1/trends?state=maharashtra
